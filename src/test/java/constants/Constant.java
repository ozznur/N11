...
public class Constant {
    ...
    public static final By LOG_IN = By.className("btnSignIn");
    public static final By EMAIL =By.id("email");
    public static final By PASSWORD = By.id("password");
    public static final By LOG_IN_BUTTON = By.id("loginButton");
    ...
    public static final By SEARCH_MARKET = By.className("searchBtn"); // gamze
